...
//                   </a>
//                   <a href="instagram.com" className="px-4">
//                     <FaInstagram className="h-6 w-6" />
//                   </a>
//                   <a href="x.com">
//                     <FaSquareXTwitter className="h-6 w-6" />
//                   </a>
//                   <a href="linkedin.com" className="px-4">
...
//             </a>
//           </div>
//           <div className="  text-sm mr-96 text-center ">
//             &copy; 2024 Accredian A Brand of FullStack Education Pvt Ltd. All
//             Rights Reserved
//           </div>
//           <a
//             href=""
//             className="absolute right-0 mx-10 mb-10 w-16 h-16 bg-contain bg-no-repeat"
